...
public class EmailService {
    ...
    public void sendVerificationEmail(Appear appear) throws MessagingException, UnsupportedEncodingException {
        String url = "http://localhost:8082/appear/verify?token=" + appear.getVerificationToken();
    ...
    public void sendPasswordResetEmail(Appear appear) throws MessagingException, UnsupportedEncodingException {
        String url = "http://localhost:8082/appear/reset-password?token=" + appear.getResetToken();
    ...
    private void sendHtmlEmail(String toEmail, String subject, String htmlContent) throws MessagingException, UnsupportedEncodingException {
        ...
        helper.setFrom("donotreply@tarunainfosoft.in", "TarunaInfosoft");
